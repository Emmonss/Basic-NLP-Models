...
def train_bq_corpus(tokenizer):
    ...
    train(train_data_path,val_data_path,tokenizer,model_name='bq_corpus')

def train_lcqmc(tokenizer):
    logger.info("train_lcqmc simsententce")
    train_data_path = '../datas/lcqmc/train.tsv'
    val_data_path = '../datas/lcqmc/dev.tsv'
    train(train_data_path,val_data_path,tokenizer,model_name='lcqmc')

def train_paws_x_zh(tokenizer):
    logger.info("train_paws_x_zh simsententce")
    train_data_path = '../datas/lcqmc/train.tsv'
    val_data_path = '../datas/lcqmc/dev.tsv'
    train(train_data_path,val_data_path,tokenizer,model_name='paws_x_zh')
#########################################################################
