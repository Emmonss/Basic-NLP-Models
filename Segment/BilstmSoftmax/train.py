...
def get_msr_data_train_save():
    ...
    train(train_path, val_path,mode='val',
          save_flag=True,model_path='./models',model_name='msr_bilstm_softmax',param_name='msr_params',
          epoch=50,lr=0.0001)

def get_pku_data_train_save():
    train_path = '../datas/ProcessData/pku_data.csv'
    train(train_path, mode='train',
          save_flag=True, model_path='./models', model_name='pku_bilstm_softmax',param_name='pku_params',
          epoch=50,lr=0.0001)
